	 ...
	 @BeforeSuite
		...
		public void afterTCExecution(ITestResult result) throws IOException {
			...
			if (result.getStatus()==ITestResult.FAILURE) {
				...
				getExtentTest().log(LogStatus.FAIL, getExtentTest().addScreencast(ScreenShotUtility.screenShot(getWebDriver(), tcName)));
				...
				getExtentTest().log(LogStatus.SKIP, getExtentTest().addScreencast(ScreenShotUtility.screenShot(getWebDriver(), tcName)));
			}
